...
//-----------------------------------------------------------------------------------------------//
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////// NAMES : Munera Sadaqah,Enas Batarfi,RandaNahhas  ////////////////////////
/////////////////////////       ID : 1911020,1906982,1906161               ////////////////////////
/////////////////////////              SECTION : BAR                      /////////////////////////
/////////////////////////              Class : MAIN                       /////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------------------------//
...
public class Application {
    ...
    /**
     * This function has two responsibilities : 1) Responsible for running the
     * make graph function according to the number of vertices n and number of
     * edges m that are specified by the user, invoking the The chosen
     * algorithm, displaying the returned result and the measured running time
     * "OR" 2) responsible for read the graph from the file and invoking the The
     * chosen algorithm, displaying the returned result and the measured running
     * time
     *
        ...
        switch (menuChoice) {
            ...
            case 1:
                ...
                if (choiceAlogrithm == 1) {
                    ...
                    floydAlg = new AllSourceSPAlg(graph);
                    //invoke setNullEdge method to create edge between the vertices that there is no edge between them
...
//                    System.out.print("Please choose the number of the source you want to begin with (from 0 to 9) : ");
